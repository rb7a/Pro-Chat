              ...
              <div className="text-center py-16">
                <div className="max-w-md mx-auto">
                  ...
                  <p className="text-white/50 mb-6">
                    Type your message or press <kbd className="px-2 py-1 bg-white/5 border border-white/10 rounded text-xs font-mono backdrop-blur-sm">Ctrl+Shift+V</kbd> for voice input
                  </p>
                </div>
              </div>
            ) : (
